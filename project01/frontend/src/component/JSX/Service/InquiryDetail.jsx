...
const DUMMY_QUESTIONS = [
  {
    id: 1,
    text: '토스 앱에서 송금을 한 뒤 송금확인증은 어떻게 발급받나요?',
    extra: '질문 글',
    detail: '송금 확인증은 토스 앱에서 “송금내역” 메뉴에 들어가 해당 내역을 선택한 뒤, “확인증 발급”을 누르시면 PDF로 저장 및 공유하실 수 있습니다.',
    createdAt: '2024-08-04'
},
  {
    id: 2,
    text: '오픈뱅킹 자동이체 문자를 받았어요.',
    extra: '질문글.',
    detail: '오픈뱅킹 자동이체는 등록한 계좌에서 자동으로 출금되는 서비스입니다. 문자 내용과 내역을 확인 후 문의가 더 필요하시면 고객센터로 문의해주세요.',
